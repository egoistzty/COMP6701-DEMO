...
###################################################################### Improvement1: try to use an iterative method instead of recursive method
...
###################################################################### Improvement2: try to use a more elegant way to record the opt, such as hashtable or dictionary
...
###################################################################### Improvement3: use the algorithm given in the lesson to solve the optimal interval searching problem
...
###################################################################### Improvement4: try to design a function to autonomously generate random interval lists each time  
#parameter setting
